...
public class mapdetails extends AppCompatActivity implements OnMapReadyCallback {
    ...
    getDeviceLocation();
        mapFragment.getMapAsync(mapdetails.this);

    }

public void home(View v){
    Intent redirect=new Intent(mapdetails.this,MainActivity.class);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(mapdetails.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
